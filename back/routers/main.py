...
from .model_scanner_router import router as model_scanner_router
...
api_router.include_router(model_scanner_router, tags=["Model Scanner"])
...
api_router.include_router(comfy_router, tags=["ComfyUI"])
